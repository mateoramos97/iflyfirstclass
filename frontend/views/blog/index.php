...
<div class="page-content">
	...
	<div class="">
		...
		<div class="blog-poster-wrapper">
			<div class="back-slide" style="background-image: linear-gradient(90deg, rgba(33, 33, 33, 0.56) 0%, rgba(33, 33, 33, 0.32) 100%), url(<?= $path_img . Html::encode($images[1]['alias']) ?>); background-position: center">
