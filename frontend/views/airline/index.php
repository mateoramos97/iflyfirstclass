...
$this->title = $airline_model->browser_title;
$this->registerMetaTag(['property' => 'og:locale', 'content' => 'en']);
$this->registerMetaTag(['property' => 'og:title', 'content' => $airline_model->browser_title]);
$this->registerMetaTag(['property' => 'og:description', 'content' => $airline_model->description]);
...
$this->params['breadcrumbs'][] = Html::encode($airline_model['name']);
...
<div itemscope="" itemtype="http://schema.org/Product">
        ...
        <div class="welcome-block container-wrapper flex flex-justify-between">
            <div class="content flex flex-align-center">
                <div>
                    ...
                    <h1>
                        <span itemprop="name">Flights to <?= Html::encode($airline_model['name']) ?></span>
                    </h1>
                    <div class="phone">
    ...
    <div class="highlight-block-wrapper">
        <div class="container-wrapper flex flex-justify-between flex-align-center">
            <div class="specials-block">
                <div class="title">
                    Special offer to <?= Html::encode($airline_model['name']) ?>
                </div>
                <div class="columns flex">
                    <div class="column column-1">
                        <div class="subtitle">Business Class</div>
                        <div class="price-old">
                            Price: <span>$<?= Html::encode($country_prices['business_class_old_price']) ?></span>
                        </div>
                        <div itemprop="offers" itemscope="" itemtype="http://schema.org/Offer" class="price-new">
                            <meta itemprop="priceCurrency" content="USD">
                            Now: <span>$</span><span itemprop="price"><?= Html::encode($country_prices['business_class_price']) ?></span>
                        </div>
                    </div>
                    <div class="column column-2">
                        <div class="subtitle">First Class</div>
                        <div class="price-old">
                            Price: <span>$<?= Html::encode($country_prices['first_class_old_price']) ?></span>
                        </div>
                        <div itemprop="offers" itemscope="" itemtype="http://schema.org/Offer" class="price-new">
                            <meta itemprop="priceCurrency" content="USD">
                            Now: <span>$</span><span itemprop="price"><?= Html::encode($country_prices['first_class_price']) ?></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="page-content">
        <div class="container-wrapper flex flex-justify-between border-box">
            <div class="content">
                <div class="body">
                    <h2><?= Html::encode($airline_model['sub_title']) ?></h2>
                    <div class="columns flex flex-justify-between">
                        <div class="column">
                            <?php echo $airline_model->body_column_1; ?>
                        </div>
                        <div class="column">
                            <?php echo $airline_model->body_column_2; ?>
                        </div>
                    </div>
                </div>
                <a href="#" class="send-request-link-form">Send Request</a>
            </div>
            <?= LandingSidebarRight::widget(['summary_sidebar' => $airline_model->summary]) ?>
        </div>
                ...
                <div class="cities column">
                    ...
                    <ul>
                        <?php foreach($airlines as $item): ?>
                            <li>
                                <a href="<?= Url::to(['airline/index', 'alias' => $item['alias']]); ?>">
                                    <?= Html::encode($item['name']) ?>
                                </a>
                            </li>
                        <?php endforeach; ?>
