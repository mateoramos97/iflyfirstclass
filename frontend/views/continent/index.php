...
<div itemscope="" itemtype="http://schema.org/Product">
        ...
        <div class="welcome-block container-wrapper flex flex-justify-between">
            <div class="content flex flex-align-center">
                <div>
                    ...
                    <h1>
                        <span itemprop="name">Flights to <?= Html::encode($continent_model['name']) ?></span>
                    </h1>
                    <div class="phone">
            ...
            <div class="specials-block">
                ...
                <div class="columns flex">
                    <div class="column column-1">
                        ...
                        <div class="price-old">
                            Price: <span>$<?= Html::encode($continent_model['business_class_old_price']) ?></span>
                        </div>
                        <div itemprop="offers" itemscope="" itemtype="http://schema.org/Offer" class="price-new">
                            <meta itemprop="priceCurrency" content="USD">
                            Now: <span>$</span><span itemprop="price"><?= Html::encode($continent_model['business_class_price']) ?></span>
                        </div>
                    </div>
                    <div class="column column-2">
                        <div class="subtitle">First Class</div>
                        <div class="price-old">
                            Price: <span>$<?= Html::encode($continent_model['first_class_old_price']) ?></span>
                        </div>
                        <div itemprop="offers" itemscope="" itemtype="http://schema.org/Offer" class="price-new">
                            <meta itemprop="priceCurrency" content="USD">
                            Now: <span>$</span><span itemprop="price"><?= Html::encode($continent_model['first_class_price']) ?></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="page-content">
        <div class="container-wrapper flex flex-justify-between border-box">
            <div class="content">
                <div class="body">
                    <h2><?= Html::encode($continent_model['sub_title']) ?></h2>
            ...
            <?= LandingSidebarRight::widget(['summary_sidebar' => $continent_model->summary]) ?>
        </div>
                ...
                <div class="cities column">
                    ...
                    <ul>
                        <?php foreach($countries as $item): ?>
                            <li>
                                <a href="<?= Url::to(['country/index', 'alias' => $item['alias']]); ?>">
                                    <?= Html::encode($item['name']) ?>
                                </a>
                            </li>
                        <?php endforeach; ?>
