...
<div class="form-block-wrapper">
    ...
    <div class="col-md-4">
        <?= $form->field($continent_model, 'browser_title') ?>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-6">
        <?= $form->field($continent_model, 'sub_title') ?>
    </div>
    <div class="col-md-4">
    ...
    <?= $form->field($continent_model, 'body_column_1')->widget(\dosamigos\ckeditor\CKEditor::className(), [
        'options' => ['rows' => 6],
        'preset' => 'full'
    ]) ?>
    <?= $form->field($continent_model, 'body_column_2')->widget(\dosamigos\ckeditor\CKEditor::className(), [
        'options' => ['rows' => 6],
        'preset' => 'full'
    ]) ?>
