...
/* @var $country_model \common\sys\repository\landing\models\Country */
?>
Create Country
<div class="form-block-wrapper">
    ...
    <div class="col-md-4">
        <?= $form->field($country_model, 'browser_title') ?>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-6">
        <?= $form->field($country_model, 'sub_title') ?>
    </div>
    <div class="col-md-4">
    ...
    <?= $form->field($country_model, 'body_column_1')->widget(\dosamigos\ckeditor\CKEditor::className(), [
        'options' => ['rows' => 6],
        'preset' => 'full'
    ]) ?>
    <?= $form->field($country_model, 'body_column_2')->widget(\dosamigos\ckeditor\CKEditor::className(), [
        'options' => ['rows' => 6],
        'preset' => 'full'
    ]) ?>
