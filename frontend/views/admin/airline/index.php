...
?>
<a href="<?php echo Url::to(['admin/airline/create']); ?>" class="btn btn-success btn-lg" style="margin-bottom:30px">Add New</a>

<?= AdminContentFilterWidget::widget([
    'page' => \app\components\AdminAppConfig::Filter_Airline_Page,
