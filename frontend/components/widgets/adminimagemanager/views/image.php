    ...
    <?php if(count($images)!= 0) { ?>
        <?php foreach($images as $image): ?>
            ...
            <li>
                ...
                <div style="float: left;">
                    <div class="file-added-wrapper <?php echo $image['alias'] === NULL ? 'hidden' : ''; ?>">
                        <div class="actions">
                ...
                <div class="components-wrapper">
                        ...
                        <?php /*<input type="hidden" name="contet_field_id" value="<?php echo $config['content_field_id']; ?>">*/ ?>
                        <input type="hidden" name="<?php echo isset($image['content_field_id']) ? 'image['.$loc_view_ind.'][content_field_id]' :  'contet_field_id'; ?>" value="<?php echo isset($image['content_field_id']) ? $image['content_field_id'] :  $config['content_field_id']; ?>">
                        <input class="file-alias" name="image[<?php echo $loc_view_ind; ?>][alias]" type="hidden" value="<?php echo isset($image['alias']) ? $image['alias'] : ''; ?>" />
                        <input class="file-title" name="image[<?php echo $loc_view_ind; ?>][title]" type="text" value="<?php echo isset($image['title']) ? $image['title'] : ''; ?>" />
                        <input class="file-queue" name="image[<?php echo $loc_view_ind; ?>][queue]" type="hidden" value="<?php echo isset($image['queue']) ? $image['queue'] : ''; ?>" />
                </div>
            ...
            <li>
                ...
                <?php } ?>
                    ...
                    <div class="components-wrapper">
                        ...
                        <input class="file-title" name="image[<?php echo $loc_view_ind; ?>][title]" type="text" value="" />
