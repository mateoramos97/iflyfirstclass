        ...
        <form action="" method="get">
            ...
            <div class="component component-select">
                <select name="country_id">
                    ...
                    <?php foreach($parametrs['countries'] as $key => $item) { ?>
                        <option value="<?php echo Html::encode($item['id']);?>"
                            <?php echo isset($filter_values['country_id']) && $filter_values['country_id'] == $item['id'] ? 'selected="selected"' : '' ?>>
