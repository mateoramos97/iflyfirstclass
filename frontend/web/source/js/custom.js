                ...
                source: function (request, response) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            const airports = result.airportsByCities;
                            response($.map(airports, function (item) {
                                const city = item.codeIataCity

                                const dataCity = cities.find(function (c) { return c.codeIataCity == city })

                                return {
                                    value: dataCity.nameCity + ', ' + dataCity.codeIso2Country + ', ' + item.codeIataAirport
                                }
                            }));
                        }
                    });
